...
const GptSearchBar = () => {
    ...
    const handleGptSearchClick = async () => {
      ...
      // Angoor, Chupke Chupke, Andaz Apna Apna, Padosan, Bombay to Goa
  ...
  return (
    <div className="pt-[10%] flex justify-center">
        <form className="w-1/2 bg-black grid grid-cols-12" onSubmit={(e)=>e.preventDefault()}>
            <input type="text" ref={searchText} className="p-4 m-4 col-span-9 bg-white text-black" placeholder={lang[langKey].gptSearchPlaceholder}
            />
